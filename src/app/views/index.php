        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">TIỆM TRÀ</h4>
                    <h1 class="mb-5 display-3 text-primary">SOLI</h1>
                        ...
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            ...
                            <li class="nav-item">
                                <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                    <span class="text-dark" style="width: 150px; padding: 5px;">Olong Thượng Hạng</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-3">
                                    <span class="text-dark" style="width: 150px; padding: 5px;">Trà Trái Cây</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-4">
                                    <span class="text-dark" style="width: 150px; padding: 5px;">CREAMY</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-5">
                                    <span class="text-dark" style="width: 150px; padding: 5px;">Fresh</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="d-flex flex-column h-100 rounded position-relative fruite-item">
                                            <div class="fruite-img" style="height: 200px;">
                                                <img src="<?= htmlspecialchars($fruits['Image']) ?>" class="w-100 h-100"
                                                    alt="<?= htmlspecialchars($fruits['Name']) ?>">
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0">
                                                        $<?= htmlspecialchars($fruits['Price']) ?> / kg</p>
                                                    <a href="#"
